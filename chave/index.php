...
<div id="header" class="skel-layers-fixed entry-header">
    ...
    <div class="top">
        <header>
            <h1 class="entry-title">CHAVE Project</h1>
        </header>
        <!-- Logo -->
        <div id="logo">
            <a href="#top" class="image avatar48"><img src="../images/chave.jpg"/></a><br>
        </div>
        <!-- Nav -->
        <nav id="nav">
            <ul>
...
<div id="main">
    ...
    <section id="sources" class="two">
        <div class="container">
            ...
            <header>
                <h2>Traces sources to use in CHAVE-Simulator</h2>
            </header>

            <div>
                <p> <a href="link-to" target="_blank">Eucalyptus Traces</a> </p>
                <ul class="default">
                    <li class="default">Articles:
                        <ul>
                ...
                <p> <a href="link-to" target="_blank">Google Traces</a> </p>
                <ul class="default">
                    <li class="default">Articles:
                        <ul>
                            <li>Load balancing;</li>
                ...
                <p> <a href="link-to" target="_blank">XXX Traces</a> </p>
                <ul class="default">
                    <li class="default">Articles:
                        <ul>
                            <li>Load balancing;</li>
